...
export default function SimulatorWidget() {
    return (
        <div className="bg-white p-6 rounded-2xl shadow-xl border border-stone-100 ring-1 ring-stone-500/10">
            ...
            <div className="space-y-3 mb-6">
                <div className="flex items-center p-3 border rounded-lg bg-slate-50 cursor-pointer hover:border-stone-500 hover:bg-stone-50 transition-colors">
